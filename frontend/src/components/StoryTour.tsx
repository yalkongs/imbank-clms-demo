 ...
 * 따라간 뒤, 은행 전체의 손실흡수력(CRO 목표)과 자본(CET1 경로)까지 올라가
...
export const TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    title: '⑨ 손실흡수력 - CRO의 약속',
    body: '개별 부실은 은행 전체의 손실흡수력 문제로 이어집니다. 지주 NPL커버리지가 82.2%까지 밀린 지금, CRO가 컨퍼런스콜에서 공언한 "연말 100% 회복"을 충당금 적립·상각·NPL 매각 세 레버로 설계합니다.',
